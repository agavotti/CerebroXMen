...
namespace CerebroXMenAPI.app_data
{
    ...
    {
        public static string MailEncriptacionClave = "wCNFtUt0HqEBaneCIg8B";
        public static byte[] MailEncriptacionSalt = Encoding.UTF8.GetBytes("JnIkdieBae0qJidjf892");
        public static byte[] ConfigSalt = Encoding.ASCII.GetBytes("o6806642kbM7c5");
